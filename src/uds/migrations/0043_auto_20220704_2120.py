...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.SmallIntegerField(
                        choices=[(1, "HOUR"), (2, "DAY")],
                        default=uds.models.stats_counters_accum.StatsCountersAccum.IntervalType["HOUR"],
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["stamp", "interval_type", "counter_type", "owner_type", "owner_id"], name="uds_stats_all"
            ),
        ),
        migrations.AddIndex(
            model_name="statscountersaccum",
