...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "manager",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="groups", to="uds.authenticator"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "provider",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="services", to="uds.provider"
                    ),
                ),
                ("uuid", models.CharField(default=None, max_length=50, null=True, unique=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "manager",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="users", to="uds.authenticator"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="preferences", to="uds.user"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="userServices",
                        to="uds.deployedservicepublication",
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_service",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="properties", to="uds.userservice"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="publication",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="changelog", to="uds.deployedservice"
            ),
        ),
        migrations.CreateModel(
            name="Calendar",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "calendar",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="rules", to="uds.calendar"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "account",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="usages", to="uds.account"
                    ),
                ),
                (
                    "user_service",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="accessMeta", through="uds.CalendarAccessMeta", to="uds.Calendar"
                    ),
                ),
                (
                    "assignedGroups",
                    models.ManyToManyField(db_table="uds__meta_grps", related_name="metaPools", to="uds.Group"),
                ),
                (
                    "image",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "meta_pool",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="members", to="uds.metapool"
                    ),
                ),
                (
                    "pool",
        ...
        migrations.AlterField(
            ...
            name="service_pool",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="calendarAccess", to="uds.deployedservice"
            ),
        ),
        migrations.AddField(
            model_name="metapool",
        ...
        migrations.AddField(
            ...
            name="meta_pool",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="calendarAccess", to="uds.metapool"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="userservice",
            index=models.Index(
                fields=["deployed_service", "cache_level", "state"], name="uds__user_s_deploye_a38d25_idx"
            ),
        ),
