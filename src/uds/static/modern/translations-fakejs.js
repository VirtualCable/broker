...
gettext("Remember that you will need the UDS launcher on your platform to access the service.");
gettext("Service ready");
gettext("UDS Launcher not launching");
gettext("It seems that you don't have UDS Launcher installed. Please, install it from here:");
gettext("UDS Launcher Download");
gettext("Service ready");
gettext("Launching UDS Launcher...</br>Please wait.");
gettext("Please wait until the service is launched.");
gettext("Remember that you will need the UDS launcher on your platform to access the service.");
...
gettext("If the service does not launchs automatically, probably you dont have the UDS Launcher installed");
gettext("You can obtain it from the");
gettext("UDS Launcher download page");
gettext("An error has occurred");
gettext("Return");
gettext("UDS Launcher");
gettext("Download UDS launcher for your platform");
