...
class StorageInfo:
    ...
    @staticmethod
    def from_dict(dictionary: collections.abc.MutableMapping[str, typing.Any], version: str = "") -> "StorageInfo":
...
class PoolInfo:
    ...
    @staticmethod
    def from_dict(data: collections.abc.MutableMapping[str, typing.Any], *, poolid: str | None = None) -> "PoolInfo":
        if "members" in data:
